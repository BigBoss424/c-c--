//ArrayDemo - demonstrate the use of arrays by reading a sequence of integers
//            by reading a sequence of integers and then displaying them and their sum
...
//            until operator enters negative number. Return the
